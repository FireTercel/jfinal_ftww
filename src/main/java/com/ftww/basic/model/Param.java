...
public class Param extends BaseModel<Param> {
	...
	private static final long serialVersionUID = 5799545725201061110L;
	...
	public Param getByIds(String ids,String i18n){
		...
		String sql = getSql("basic.param.idAndI18n", paramMap);
	...
	public Param getByNumber(String number){
		String sql = getSql("basic.param.numbers");
	...
	public Param getByNumber(String number, String i18n){
		...
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("val", val);
		String sql = getSql("basic.param.numbersAndI18n", paramMap);
		Param param = dao.findFirst(sql, number);
		return param;
	}
	 ...
	 * @return
	 */
	public List<Param> getChild(String parentIds){
		String sql = getSql("basic.param.child");
	...
	public List<Param> getChild(String prentIds, String i18n){
		...
		param.put("val", val);
		String sql = getSql("basic.param.childAndI8n", param);
	...
	public Param getParent(){
		String sql = getSql("basic.param.parent");
	...
	public Param getParent(String i18n){
		...
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("val", val);
		String sql = getSql("basic..parentAndI18n", param);
		return dao.findFirst(sql, get("parentids"));
	}
