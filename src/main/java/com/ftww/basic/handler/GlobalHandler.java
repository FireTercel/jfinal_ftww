...
import com.ftww.basic.beetl.render.MyBeetlRender;
...
public class GlobalHandler extends Handler{
	...
	public void handle(String target, HttpServletRequest request,
		...
		reqSysLog.set("startdate", DateTimeKit.getSqlTimestamp(starttime));//开始时间
		...
		if(null != localePram && !localePram.isEmpty()){
			...
			WebKit.addCookie(response,  "", "/", true, "language", localePram, maxAge);
		}else {
			localePram = WebKit.getCookieValueByName(request, "language");
			if(null == localePram || localePram.isEmpty()){
		...
		reqSysLog.set("enddate", DateTimeKit.getSqlTimestamp(endtime));
