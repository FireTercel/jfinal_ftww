...
public class Dict extends BaseModel<Dict> {
	...
	private static final long serialVersionUID = 1271164989270325332L;
	
	private static Logger log=Logger.getLogger(Dict.class);
	
	public final static Dict dao=new Dict();
	...
	public Dict getByIds(String ids,String i18n){
		...
		param.put("val", val);
		String sql = getSql("basic.dict.idAndI18n", param);
	...
	public Dict getByNumber(String number){
		String sql = getSql("basic.dict.numbers");
	...
	public Dict getByNumber(String number, String i18n){
		...
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("val", val);
		String sql = getSql("basic.dict.numbersAndI18n", param);
		Dict dict = dao.findFirst(sql, number);
		return dict;
	}
	 ...
	 * @return
	 */
	public List<Dict> getChild(String parentIds){
		String sql = getSql("basic.dict.child");
		return dao.find(sql, parentIds);
	}
	 ...
	 * @return
	 */
	public List<Dict> getChild(String parentIds,String i18n){
		String val = "val" + i18n(i18n);
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("val", val);
		String sql = getSql("basic.dict.childAndI8n", param);
		return dao.find(sql, parentIds);
	}
	...
	public Dict getParent(){
		String sql = getSql("basic.dict.parent");
	...
	public Dict getParent(String i18n){
		...
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("val", val);
		String sql = getSql("basic.dict.parentAndI18n", param);
		return dao.findFirst(sql, get("parentids"));
	}
