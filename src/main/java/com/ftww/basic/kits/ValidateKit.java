...
public class ValidateKit {
	...
	public static boolean isPhone(String value) {
		...
		String mobilecheck = "^(13[0-9]|14[0-9]|15[0|1|2|3|5|6|7|8|9]|17[6|7|8]|18[0-9]|19[2])\\d{8}$";
	...
	public static void main(String[] args) {
		...
		// 测试代码
		String[] strs = { "http://www.13.com", "https://www.asdf.com.cn/asdf", "www.23.com", "http://www.123.com/tsf",
				"http://www.abc.com/ab:2525/a.asp", "http://www.123.com:2563/tsf/a.html?a=2&&b=abc", "http://www.aa.com/servlet",
				"http://ee.com/abcSerlvet?a=8&&b=asdf", "ftp://192.168.0.2:8080", "http://ww.ss.com/////", "http://ww.gg.cn/" };
		for (int i = 0; i < strs.length; i++) {
			System.out.printf("%s --> %s%n", strs[i], ValidateKit.isUrl(strs[i]));
		}
		System.out.println("--------------------------------");
		...
		// }
		System.out.println("UUID:" + ValidateKit.isUUID("ee706ee9-1658-43d0-bc1f-2db23cab4ab2"));
	}
