...
public class GroupService extends BaseService {
	...
	public Map<String,Object> select(String ids){
		...
		if(null != groupIds && !groupIds.equals("")){
			...
			noCheckedList = Group.dao.find(getSql("basic.group.noCheckedFilter", param));
			checkedList = Group.dao.find(getSql("basic.group.checkedFilter", param));
		}else{
			noCheckedList = Group.dao.find(getSql("basic.group.noChecked"));
		}
	...
	public void list(SplitPage splitPage){
		...
		splitPageBase(DictKeys.db_dataSource_main, splitPage, select, "basic.group.splitPage");
	}
